...
(define pkg-desc "Experimental standalone CPU Skia drawing, Unicode line breaking, mixed-script/bidi text layout, paragraph text layout, HarfBuzz shaping, font management/text blobs, expanded paths/SVG geometry, filters, pictures/recording, vector effects, text, shaders, and image codecs through the SkiaSharp C ABI")
