...
**0.15–0.16 Unicode conformance — LIVE VALIDATED.** The 175-case source/native
suite and doctor probes were green before the final line-break conformance
refinements. The final Unicode 15.1 run passed **10274/10274 LineBreakTest** and
...
Expected additional doctor line for 0.17:

```text
Break providers passed; external segmentation and discretionary hyphen insertion verified
```
